...
/** url like this:
 * Get All Products:        http://localhost:8080/api/products?pageSize=4&pageNumber=1
 * Get Product by Category: http://localhost:8080/api/products/category?id=1&pageSize=4&pageNumber=1
 * Search:                  http://localhost:8080/api/products?q=something&pageSize=4&pageNumber=1
 */
/**
