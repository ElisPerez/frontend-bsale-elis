...
/** url like this:
 * GetAllProducts: https://bsale-shop-backend-elis.herokuapp.com/api/products?pageSize=4&pageNumber=1
 * ProductByCategory: https://bsale-shop-backend-elis.herokuapp.com/api/products/category?id=1&pageSize=4&pageNumber=1
 * Search: https://bsale-shop-backend-elis.herokuapp.com/api/products?q=something&pageSize=4&pageNumber=1
 */
/**
 * It's a jQuery plugin that allows you to create a pagination
 * @returns the value of the variable dataHTML.
 */
